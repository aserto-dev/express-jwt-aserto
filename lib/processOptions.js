...
module.exports = (options, req, res, next) => {
  ...
  let authorizerCertFile =
    '$HOME/.config/aserto/aserto-one/certs/aserto-one-gateway-ca.crt';
  if (
    options &&
  ...
  if (!disableTlsValidation) {
    ...
    try {
      ...
      console.error(`Certificate for CA not found at ${authorizerCertFile}. 
      To disable TLS certificate validation, use the 'disableTlsValidation: true' option.`);
      throw error;
    }
  }
